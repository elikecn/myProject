...
MySQL - 5.5.20 : Database - jspxcmsv6
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`jspxcmsv6` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Data for the table `cms_ad_slot` */
...
/*Data for the table `cms_attachment_ref` */
...
/*Data for the table `cms_attribute` */

LOCK TABLES `cms_attribute` WRITE;

insert  into `cms_attribute`(`f_attribute_id`,`f_site_id`,`f_number`,`f_name`,`f_seq`,`f_is_with_image`,`f_is_scale`,`f_is_exact`,`f_is_watermark`,`f_image_width`,`f_image_height`) values (1,1,'focus','焦点',0,'1','0','0','0',318,212),(2,1,'headlines','头条',6,'0','0','0','0',NULL,NULL),(5,1,'focusnews','新闻焦点',1,'1','0','0','0',660,250),(6,1,'focusphoto','图片焦点',2,'1','0','0','0',1000,500),(7,1,'focusvideo','视频焦点',3,'1','0','0','0',1000,410),(8,1,'focusproduct','产品焦点',4,'1','0','0','0',770,190),(9,1,'focusdownload','下载焦点',5,'1','0','0','0',310,210);
...
/*Data for the table `cms_collect_field` */
...
/*Data for the table `cms_collect_log` */
...
insert  into `cms_comment`(`f_comment_id`,`f_parent_id`,`f_site_id`,`f_creator_id`,`f_auditor_id`,`f_ftype`,`f_fid`,`f_creation_date`,`f_audit_date`,`f_ip`,`f_score`,`f_status`,`f_text`) values (16,NULL,1,1,NULL,'Info',28,'2014-02-22 12:40:48',NULL,'0:0:0:0:0:0:0:1',0,1,'很好看。我很喜欢。'),(17,NULL,1,1,NULL,'Info',35,'2014-04-04 20:35:51',NULL,'0:0:0:0:0:0:0:1',0,1,'现在除了情人节、七夕节等传统的结婚登记吉日，5.20、9.9等谐音吉日也越来越受到年轻人的追捧。'),(18,NULL,1,0,NULL,'Info',100,'2014-04-04 20:36:28',NULL,'0:0:0:0:0:0:0:1',0,1,'西班牙正考虑将直布罗陀争议诉至联合国与海牙国际法庭等国际机构，并考虑与阿根廷结成统一阵线'),(19,NULL,1,0,NULL,'Info',73,'2014-04-04 20:40:51',NULL,'0:0:0:0:0:0:0:1',0,1,'生活中不仅有幸福和快乐，更有悲伤和无奈，都要笑纳，因为它们都是生活的组成部分。'),(20,NULL,1,0,NULL,'Info',26,'2014-04-04 20:41:28',NULL,'0:0:0:0:0:0:0:1',0,1,'请市民减少出行，注意交通安全，山区防山洪、滑坡、泥石流地质灾害');
...
insert  into `cms_friendlink`(`f_friendlink_id`,`f_friendlinktype_id`,`f_site_id`,`f_name`,`f_url`,`f_seq`,`f_logo`,`f_description`,`f_email`,`f_is_with_logo`,`f_is_recommend`,`f_status`) values (7,1,1,'JSPXCMS官方','http://www.jspxcms.com',2147483647,NULL,NULL,NULL,'0','0',0),(8,3,1,'JAVA','http://www.java.com',2147483647,NULL,NULL,NULL,'0','0',0),(9,3,1,'TOMCAT','http://tomcat.apache.org',2147483647,NULL,NULL,NULL,'0','0',0);
...
/*Data for the table `cms_friendlink_type` */

LOCK TABLES `cms_friendlink_type` WRITE;

insert  into `cms_friendlink_type`(`f_friendlinktype_id`,`f_site_id`,`f_name`,`f_number`,`f_seq`) values (1,1,'综合类','zonghe',0),(3,1,'技术类','yule',1);
...
/*Data for the table `cms_global` */

LOCK TABLES `cms_global` WRITE;

insert  into `cms_global`(`f_global_id`,`f_protocol`,`f_port`,`f_context_path`,`f_is_with_domain`,`f_uploads_publishpoint_id`,`f_captcha_errors`,`f_version`) values (1,'http',8080,NULL,'1',1,3,'6.0.0');
...
/*Data for the table `cms_global_clob` */
...
/*Data for the table `cms_guestbook_type` */

LOCK TABLES `cms_guestbook_type` WRITE;

insert  into `cms_guestbook_type`(`f_guestbooktype_id`,`f_site_id`,`f_name`,`f_number`,`f_seq`,`f_description`) values (1,1,'咨询','zixun',1,'咨询'),(4,1,'投诉','tousu',2,'投诉'),(5,1,'建议','jianyi',3,'建议'),(6,1,'反馈','fankui',4,'反馈'),(7,1,'其他','qita',5,'其他'),(8,1,'普通','putong',0,NULL);
...
/*Data for the table `cms_info_buffer` */

LOCK TABLES `cms_info_buffer` WRITE;

insert  into `cms_info_buffer`(`f_info_id`,`f_views`,`f_downloads`,`f_comments`,`f_involveds`,`f_diggs`,`f_burys`,`f_score`) values (24,3,0,0,0,0,0,0),(26,8,0,0,0,0,0,0),(27,1,0,0,0,0,0,0),(28,2,0,0,0,0,0,2),(30,1,0,0,0,0,0,0),(32,8,0,0,0,0,0,1),(33,7,0,0,0,0,0,0),(35,2,0,0,0,0,0,0),(36,4,0,0,0,0,0,0),(43,6,0,0,0,0,0,0),(44,3,0,0,0,0,0,0),(45,7,0,0,0,0,0,0),(46,2,0,0,0,0,0,0),(48,5,0,0,0,0,0,0),(49,4,0,0,0,0,0,0),(50,2,0,0,0,0,0,0),(52,1,0,0,0,0,0,0),(53,1,0,0,0,0,0,0),(54,8,0,0,0,0,0,0),(73,1,0,0,0,3,0,0),(78,4,0,0,0,0,0,0),(80,9,0,0,0,0,0,0),(81,6,0,0,0,0,0,0),(83,7,0,0,0,0,1,0),(87,4,0,0,0,0,0,2),(93,3,0,0,0,0,0,9),(94,8,0,0,0,0,0,9),(95,7,0,0,0,0,0,3),(97,5,0,0,0,0,0,8),(98,7,0,0,0,0,0,2),(99,0,0,0,0,0,0,0),(100,2,0,0,0,0,0,0),(117,1,0,0,0,0,0,0),(118,5,0,0,0,0,0,0),(126,5,0,0,0,0,1,0),(127,5,0,0,0,0,0,0),(128,1,0,0,0,0,0,0),(129,7,0,0,0,0,0,0),(130,6,0,0,0,0,0,9),(131,1,0,0,0,0,0,0),(132,6,0,0,0,0,0,0),(133,1,0,0,0,0,0,0),(134,3,0,0,0,0,0,0),(135,0,0,0,0,0,0,0),(136,1,0,0,0,0,0,0),(137,4,0,0,0,0,0,0),(138,3,0,0,0,0,0,0),(139,3,0,0,0,0,0,0),(140,1,0,0,0,0,0,0),(141,9,0,0,0,0,0,0),(142,9,0,0,0,0,0,0),(143,7,0,0,0,0,0,0),(144,4,0,0,0,0,0,0),(145,2,0,0,0,0,0,0),(146,6,0,0,0,0,0,0),(148,1,0,0,0,0,0,0),(149,3,0,0,0,0,0,0),(150,1,0,0,0,0,0,0),(151,2,0,0,0,0,0,0),(162,3,0,0,0,0,0,0),(163,3,0,0,0,0,0,0),(164,1,0,0,0,0,0,0),(165,8,0,0,0,0,0,0),(166,4,0,0,0,0,0,0),(167,3,0,0,0,0,0,0),(168,3,0,0,0,0,0,0),(169,1,0,0,0,0,0,0),(170,7,0,0,0,0,0,0),(172,6,0,0,0,0,0,0),(173,8,0,0,0,0,0,0),(174,1,0,0,0,0,0,0),(180,0,0,0,0,0,0,0);
...
/*Data for the table `cms_info_clob` */
...
/*Data for the table `cms_info_detail` */
...
/*Data for the table `cms_info_file` */
...
/*Data for the table `cms_info_node` */

LOCK TABLES `cms_info_node` WRITE;

insert  into `cms_info_node`(`f_infonode_id`,`f_info_id`,`f_node_id`,`f_node_index`) values (10,47,40,0),(141,28,42,-1),(143,25,42,-1),(158,24,42,-1),(161,30,44,-1),(175,44,38,-1),(176,43,38,-1),(177,73,38,-1),(178,45,38,-1),(180,49,40,-1),(217,117,69,-1),(218,118,69,-1),(231,53,42,-1),(232,52,42,-1),(236,27,42,-1),(238,36,42,-1),(239,33,42,-1),(240,34,42,-1),(262,46,38,-1),(263,54,42,-1),(264,48,40,-1),(310,135,77,-1),(311,134,79,-1),(312,133,79,-1),(313,93,78,-1),(314,83,79,-1),(320,137,80,-1),(321,138,80,-1),(329,127,42,-1),(331,99,44,-1),(333,35,42,-1),(337,140,81,-1),(338,139,81,-1),(354,26,40,-1),(356,50,40,-1),(357,144,69,-1),(359,145,69,-1),(360,146,69,-1),(365,148,78,-1),(367,149,78,-1),(368,150,79,-1),(371,128,42,-1),(372,126,42,-1),(373,32,44,-1),(374,100,44,-1),(375,143,88,0),(376,142,87,0),(378,78,88,0),(379,141,88,0),(383,81,90,0),(385,87,82,0),(396,130,83,0),(399,95,85,0),(403,98,83,0),(404,97,83,0),(409,163,94,0),(412,166,82,0),(413,167,82,0),(414,168,80,0),(415,169,80,0),(417,165,88,0),(421,151,82,0),(422,170,81,0),(423,172,82,0),(424,173,82,0),(425,174,81,0),(433,180,44,0),(434,80,90,0),(435,164,87,0),(436,129,84,0),(437,131,96,0),(438,132,95,0),(439,94,84,0),(440,136,77,0),(441,162,93,0);
...
/*Data for the table `cms_info_special` */

LOCK TABLES `cms_info_special` WRITE;

insert  into `cms_info_special`(`f_infospecial_id`,`f_info_id`,`f_special_id`,`f_special_index`) values (7,32,11,0),(8,49,8,0),(9,50,8,0),(10,48,8,0),(11,47,8,0),(12,30,10,0),(13,44,2,0),(14,43,2,0),(15,73,2,0),(16,45,2,0),(17,128,13,0),(18,53,11,0),(19,24,8,0),(20,25,12,0),(21,34,10,0),(22,127,10,0),(23,35,2,0),(24,28,12,0),(25,36,10,0),(26,27,13,0),(27,126,10,0),(28,99,10,0),(29,26,12,0);
...
/*Data for the table `cms_info_tag` */

LOCK TABLES `cms_info_tag` WRITE;

insert  into `cms_info_tag`(`f_infotag_id`,`f_info_id`,`f_tag_id`,`f_tag_index`) values (20,30,56,0),(21,30,71,1),(22,30,72,2),(23,30,73,3),(31,53,63,0),(32,53,64,1),(33,53,65,2),(34,53,66,3),(35,52,67,0),(36,52,68,1),(37,52,69,2),(38,52,70,3),(55,54,56,0),(56,54,57,1),(57,54,62,2),(58,78,78,0),(59,78,79,1),(60,78,80,2),(65,128,81,0),(66,128,82,1),(67,128,83,2),(68,166,84,0),(69,168,84,0),(70,170,84,0),(71,167,84,0),(72,151,84,0),(73,169,84,0),(74,87,84,0),(75,140,84,0),(76,137,84,0),(77,139,84,0),(78,138,84,0),(79,174,84,0),(80,173,84,0),(81,172,84,0);
...
/*Data for the table `cms_member_group` */

LOCK TABLES `cms_member_group` WRITE;

insert  into `cms_member_group`(`f_membergroup_id`,`f_name`,`f_description`,`f_ip`,`f_type`,`f_seq`) values (0,'游客组',NULL,NULL,1,0),(1,'普通会员',NULL,NULL,0,2147483647);
...
insert  into `cms_node`(`f_node_id`,`f_site_id`,`f_parent_id`,`f_creator_id`,`f_node_model_id`,`f_workflow_id`,`f_info_model_id`,`f_number`,`f_name`,`f_tree_number`,`f_tree_level`,`f_tree_max`,`f_creation_date`,`f_refers`,`f_views`,`f_is_real_node`,`f_is_hidden`,`f_html_status`,`f_p0`,`f_p1`,`f_p2`,`f_p3`,`f_p4`,`f_p5`,`f_p6`) values (1,1,NULL,1,1,NULL,2,NULL,'首页','0000',0,'000a','2013-02-21 20:59:27',-43,140,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(36,1,1,1,3,NULL,2,'news','新闻','0000-0000',1,'0005','2013-03-04 22:18:36',-9,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(38,1,36,1,3,NULL,2,'yule','娱乐','0000-0000-0003',2,'0000','2013-03-04 22:18:42',-7,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(40,1,36,1,3,NULL,2,'sport','体育','0000-0000-0004',2,'0000','2013-03-18 01:27:48',-2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(42,1,36,1,3,NULL,2,'domestic','国内','0000-0000-0000',2,'0001','2013-03-18 01:30:03',-6,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(44,1,36,1,3,NULL,2,NULL,'国际','0000-0000-0001',2,'0000','2013-03-18 01:33:48',-20,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(48,1,1,1,4,NULL,5,'photo','图片','0000-0001',1,'0003','2013-08-06 02:11:53',2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(49,1,1,1,6,NULL,7,'download','下载','0000-0004',1,'0003','2013-08-06 08:45:34',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(51,1,1,1,8,NULL,9,'video','视频','0000-0002',1,'0003','2013-08-08 01:42:51',0,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(52,1,1,1,10,NULL,11,'product','产品','0000-0003',1,'0005','2013-08-08 05:56:39',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(67,1,1,1,16,NULL,NULL,'guestbook','留言','0000-0008',1,'0000','2013-08-09 08:44:10',0,0,'0','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(68,1,1,1,16,NULL,NULL,'bbs','论坛','0000-0009',1,'0000','2013-08-14 06:41:58',0,0,'0','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(69,1,1,1,13,NULL,21,'jobs','招聘','0000-0007',1,'0000','2014-03-18 14:13:23',5,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(74,1,1,1,16,NULL,NULL,NULL,'专题','0000-0006',1,'0000','2014-03-26 11:56:45',0,0,'0','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(77,1,49,1,6,NULL,7,NULL,'媒体软件','0000-0004-0000',2,'0000','2014-04-01 16:58:31',2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(78,1,49,1,6,NULL,7,NULL,'网络软件','0000-0004-0001',2,'0000','2014-04-01 16:59:19',3,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(79,1,49,1,6,NULL,7,NULL,'系统工具','0000-0004-0002',2,'0000','2014-04-01 16:59:24',4,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(80,1,51,1,8,NULL,9,NULL,'电影','0000-0002-0000',2,'0000','2014-04-02 16:54:36',4,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(81,1,51,1,8,NULL,9,NULL,'电视剧','0000-0002-0001',2,'0000','2014-04-02 16:54:42',4,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(82,1,51,1,8,NULL,23,NULL,'综艺','0000-0002-0002',2,'0000','2014-04-02 16:56:04',6,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(83,1,52,1,10,NULL,24,NULL,'手机/数码','0000-0003-0000',2,'0000','2014-04-02 16:59:26',3,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(84,1,52,1,10,NULL,25,NULL,'电脑办公','0000-0003-0001',2,'0000','2014-04-02 17:02:14',2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(85,1,52,1,10,NULL,11,NULL,'服饰/内衣','0000-0003-0002',2,'0000','2014-04-02 17:02:26',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(87,1,48,1,4,NULL,5,NULL,'自然景观','0000-0001-0002',2,'0000','2014-06-01 18:54:54',2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(88,1,48,1,4,NULL,5,NULL,'人物图库','0000-0001-0000',2,'0000','2014-06-01 18:55:10',4,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(90,1,48,1,4,NULL,5,NULL,'旅游摄影','0000-0001-0001',2,'0000','2014-06-01 18:58:27',2,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(92,1,1,1,19,NULL,20,'doc','文库','0000-0005',1,'0002','2014-06-01 19:01:26',0,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(93,1,92,1,19,NULL,20,NULL,'教育文库','0000-0005-0000',2,'0000','2014-06-01 19:02:34',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(94,1,92,1,19,NULL,20,NULL,'专业资料','0000-0005-0001',2,'0000','2014-06-01 19:02:48',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(95,1,52,1,10,NULL,26,NULL,'图书/音像','0000-0003-0003',2,'0000','2014-12-17 12:01:36',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(96,1,52,1,10,NULL,27,NULL,'家用电器','0000-0003-0004',2,'0000','2014-12-17 12:02:24',1,0,'1','0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
/*Data for the table `cms_node_buffer` */

LOCK TABLES `cms_node_buffer` WRITE;

insert  into `cms_node_buffer`(`f_node_id`,`f_views`) values (1,7),(38,5),(42,1),(44,2),(48,0),(49,0),(51,0),(52,0),(67,0),(68,0),(69,0),(74,0),(77,0),(78,0),(79,0),(80,0),(81,0),(82,0),(83,0),(84,0),(85,0),(87,0),(88,0),(90,0),(92,0),(93,0),(94,0),(95,0),(96,0);
...
/*Data for the table `cms_node_clob` */
...
/*Data for the table `cms_node_custom` */
...
/*Data for the table `cms_node_membergroup` */

LOCK TABLES `cms_node_membergroup` WRITE;

insert  into `cms_node_membergroup`(`f_nodemgroup_id`,`f_node_id`,`f_membergroup_id`,`f_is_view_perm`,`f_is_contri_perm`,`f_is_comment_perm`) values (1,1,1,'1','1','1'),(2,36,1,'1','1','1'),(3,42,1,'1','1','1'),(4,44,1,'1','1','0'),(6,48,1,'1','1','1'),(7,51,1,'1','1','1'),(9,38,1,'1','1','1'),(10,40,1,'1','1','1'),(12,52,1,'1','1','1'),(13,49,1,'1','1','1'),(16,68,1,'1','1','1'),(17,67,1,'1','1','1'),(18,1,0,'1','1','1'),(19,36,0,'1','1','1'),(20,42,0,'1','1','1'),(21,44,0,'1','1','1'),(23,48,0,'1','1','1'),(24,51,0,'1','1','1'),(26,38,0,'1','1','1'),(27,40,0,'1','1','1'),(29,52,0,'1','1','1'),(30,49,0,'1','1','1'),(33,68,0,'1','1','1'),(34,67,0,'1','1','1'),(35,69,0,'1','0','0'),(36,69,1,'1','0','0'),(45,74,0,'1','1','1'),(46,74,1,'1','1','1'),(49,77,0,'1','1','1'),(50,77,1,'1','1','1'),(51,78,0,'1','1','1'),(52,78,1,'1','1','1'),(53,79,0,'1','1','1'),(54,79,1,'1','1','1'),(55,80,0,'1','1','1'),(56,80,1,'1','1','1'),(57,81,0,'1','1','1'),(58,81,1,'1','1','1'),(59,82,0,'1','1','1'),(60,82,1,'1','1','1'),(61,83,0,'1','1','1'),(62,83,1,'1','1','1'),(63,84,0,'1','1','1'),(64,84,1,'1','1','1'),(65,85,0,'1','1','1'),(66,85,1,'1','1','1'),(69,87,0,'1','1','1'),(70,87,1,'1','1','1'),(71,88,0,'1','1','1'),(72,88,1,'1','1','1'),(75,90,0,'1','1','1'),(76,90,1,'1','1','1'),(79,92,0,'1','1','1'),(80,92,1,'1','1','1'),(81,93,0,'1','1','1'),(82,93,1,'1','1','1'),(83,94,0,'1','1','1'),(84,94,1,'1','1','1'),(85,95,0,'1','1','1'),(86,95,1,'1','1','1'),(87,96,0,'1','1','1'),(88,96,1,'1','1','1');
...
/*Data for the table `cms_node_org` */

LOCK TABLES `cms_node_org` WRITE;

insert  into `cms_node_org`(`f_nodeorg_id`,`f_org_id`,`f_node_id`,`f_is_view_perm`) values (2,1,69,'0'),(3,1,67,'0'),(4,1,68,'0'),(10,1,48,'0'),(11,1,74,'0'),(13,1,77,'0'),(14,1,78,'0'),(15,1,79,'0'),(16,1,80,'0'),(17,1,81,'0'),(18,1,82,'0'),(19,1,83,'0'),(20,1,84,'0'),(21,1,85,'0'),(22,1,1,'0');
...
/*Data for the table `cms_operation_log` */

LOCK TABLES `cms_operation_log` WRITE;

insert  into `cms_operation_log`(`f_operation_id`,`f_user_id`,`f_site_id`,`f_name`,`f_data_id`,`f_description`,`f_text`,`f_ip`,`f_time`,`f_type`) values (1142,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 11:30:16',2),(1143,1,1,'opr.personal.password.edit',1,'admin',NULL,'127.0.0.1','2016-02-03 11:30:51',1),(1144,1,1,'login.logout',NULL,NULL,NULL,'127.0.0.1','2016-02-03 11:31:06',2),(1145,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 11:31:12',2),(1146,1,1,'opr.confGlobal.baseEdit',1,NULL,NULL,'127.0.0.1','2016-02-03 11:32:20',1),(1147,1,1,'opr.site.edit',1,'Jspxcms演示主站',NULL,'127.0.0.1','2016-02-03 11:33:58',1),(1148,1,1,'opr.html.makeAll',1,'Jspxcms演示主站',NULL,'127.0.0.1','2016-02-03 11:35:27',1),(1149,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 14:01:53',2),(1150,1,1,'opr.resume.export',3,'123',NULL,'127.0.0.1','2016-02-03 14:03:45',1),(1151,1,1,'opr.resume.export',3,'123',NULL,'127.0.0.1','2016-02-03 14:18:40',1),(1152,1,1,'opr.resume.export',4,'王大锤',NULL,'127.0.0.1','2016-02-03 14:18:40',1),(1153,1,1,'opr.resume.export',3,'123',NULL,'127.0.0.1','2016-02-03 14:54:45',1),(1154,1,1,'opr.resume.export',4,'王大锤',NULL,'127.0.0.1','2016-02-03 14:54:45',1),(1155,1,1,'login.logout',NULL,NULL,NULL,'127.0.0.1','2016-02-03 15:04:47',2),(1156,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 15:05:11',2),(1157,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 15:24:43',2),(1158,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 15:57:27',2),(1159,1,1,'login.success',NULL,NULL,NULL,'127.0.0.1','2016-02-03 20:13:21',2),(1160,1,1,'opr.resume.export',3,'123',NULL,'127.0.0.1','2016-02-04 12:56:48',1),(1161,1,1,'opr.resume.export',4,'王大锤',NULL,'127.0.0.1','2016-02-04 12:56:48',1),(1162,1,1,'opr.resume.edit',4,'王大锤',NULL,'127.0.0.1','2016-02-04 13:58:54',1),(1163,1,1,'opr.resume.edit',3,'123',NULL,'127.0.0.1','2016-02-04 13:59:06',1),(1164,1,1,'opr.resume.export',3,'123',NULL,'127.0.0.1','2016-02-04 13:59:10',1),(1165,1,1,'opr.resume.export',4,'王大锤',NULL,'127.0.0.1','2016-02-04 13:59:10',1),(1166,1,1,'login.logout',NULL,NULL,NULL,'127.0.0.1','2016-02-04 13:59:25',2);
...
/*Data for the table `cms_publish_point` */

LOCK TABLES `cms_publish_point` WRITE;

insert  into `cms_publish_point`(`f_publishpoint_id`,`f_global_id`,`f_name`,`f_description`,`f_store_path`,`f_display_path`,`f_ftp_hostname`,`f_ftp_port`,`f_ftp_username`,`f_ftp_password`,`f_seq`,`f_method`,`f_type`) values (1,1,'附件默认发布点',NULL,'/uploads','/uploads',NULL,NULL,NULL,NULL,2147483647,1,2),(2,1,'HTML默认发布点',NULL,NULL,NULL,NULL,NULL,NULL,NULL,2147483647,1,1);
...
/*Data for the table `cms_question` */

LOCK TABLES `cms_question` WRITE;

insert  into `cms_question`(`f_question_id`,`f_site_id`,`f_title`,`f_description`,`f_begin_date`,`f_end_date`,`f_creation_date`,`f_mode`,`f_interval`,`f_total`,`f_status`) values (1,1,'广州恒大再夺亚冠，你怎么看','在刚刚结束的2015赛季亚冠决赛次回合比赛中，广州恒大凭借埃尔克森的进球， 1-0战胜迪拜阿赫利，总比分1-0获得本赛季亚冠联赛冠军，同时这也是恒大3年内两夺亚冠。',NULL,NULL,'2015-12-05 22:32:54',1,0,3,0),(2,1,'南方供暖已成各界共识，你对江西供暖怎么看？','近年来，每逢供暖期，呼吁“南方集中供暖”的话题都会成为热点。清华大学建筑节能研究中心的调研报告显示，并非所有南方城市有供暖需求，真正需要的是国家划定的“夏热冬冷”地区，包括上海、重庆、湖北、湖南、安徽、江西、江苏、浙江、四川等。这些省份冬季室温远低于北方城市集中供热时的室内温度。作为一个江西人，你对江西供暖怎么看？',NULL,NULL,'2015-12-01 16:38:50',1,0,0,0);
...
/*Data for the table `cms_question_item` */

LOCK TABLES `cms_question_item` WRITE;

insert  into `cms_question_item`(`f_questionitem_id`,`f_question_id`,`f_title`,`f_max_selected`,`f_seq`,`f_is_essay`) values (1,1,'广州恒大再夺亚冠主要原因是什么?',0,0,'0'),(2,1,'恒大本场决赛最佳球员是谁?',1,1,'0'),(4,2,'你支持江西供暖吗？',1,0,'0'),(5,2,'你觉得“集中供暖”和“分散供暖”哪个模式比较好？',1,1,'0'),(6,2,'如果采取供暖，你比较担心以下哪些问题？',1,2,'0'),(7,2,'您有什么建议？',1,3,'1');
...
/*Data for the table `cms_question_item_rec` */
...
/*Data for the table `cms_question_opt_rec` */

LOCK TABLES `cms_question_opt_rec` WRITE;

insert  into `cms_question_opt_rec`(`f_questionoptrec_id`,`f_questionrecord_id`,`f_questionoption_id`) values (4,3,1),(5,3,2),(6,3,7);
...
/*Data for the table `cms_question_option` */

LOCK TABLES `cms_question_option` WRITE;

insert  into `cms_question_option`(`f_questionoption_id`,`f_questionitem_id`,`f_title`,`f_is_input`,`f_count`,`f_seq`) values (1,1,'斯科拉里中途上任，对球队调教有方','0',1,0),(2,1,'高拉特、保利尼奥加盟，成功补强球队','0',1,1),(3,2,'埃尔克森','0',1,0),(4,2,'郑龙','0',0,1),(5,1,'郑智、黄博文、冯潇霆等国内球员给力','0',1,2),(6,1,'其他','0',0,3),(7,2,'金英权','0',1,2),(8,2,'其他','0',1,3),(9,4,'支持','0',0,0),(10,4,'不支持','0',0,1),(11,4,'无所谓','0',0,2),(12,5,'集中供暖比较好','0',0,0),(13,5,'分散供暖比较好','0',0,1),(14,5,'无所谓','0',0,2),(15,6,'花销','0',0,0),(16,6,'环境污染','0',0,1),(17,6,'冷热不均','0',0,2),(18,6,'生活习惯改变引起身体不适','0',0,3);
...
/*Data for the table `cms_question_record` */
...
/*Data for the table `cms_schedule_job` */

LOCK TABLES `cms_schedule_job` WRITE;

insert  into `cms_schedule_job`(`f_schedulejob_id`,`f_site_id`,`f_user_id`,`f_name`,`f_group`,`f_code`,`f_data`,`f_description`,`f_cron_expression`,`f_start_time`,`f_end_time`,`f_start_delay`,`f_repeat_interval`,`f_unit`,`f_cycle`,`f_status`) values (1,1,1,'信息定时发布',NULL,'com.jspxcms.core.quartz.InfoPublishJob','{\"userId\":\"1\",\"siteName\":\"Jspxcms演示主站\",\"siteId\":\"1\"}',NULL,NULL,NULL,NULL,0,10,3,2,0);
...
/*Data for the table `cms_score_group` */

LOCK TABLES `cms_score_group` WRITE;

insert  into `cms_score_group`(`f_scoregroup_id`,`f_site_id`,`f_name`,`f_number`,`f_description`,`f_seq`) values (1,1,'心情评分','mood',NULL,0),(2,1,'星级评分','star',NULL,1);
...
/*Data for the table `cms_score_item` */

LOCK TABLES `cms_score_item` WRITE;

insert  into `cms_score_item`(`f_scoreitem_id`,`f_scoregroup_id`,`f_site_id`,`f_name`,`f_score`,`f_icon`,`f_seq`) values (1,1,1,'感动',1,'/mood/0.gif',0),(2,1,1,'路过',1,'/mood/1.gif',1),(3,1,1,'高兴',1,'/mood/2.gif',2),(4,1,1,'难过',1,'/mood/3.gif',3),(5,1,1,'搞笑',1,'/mood/4.gif',4),(6,1,1,'无聊',1,'/mood/5.gif',5),(7,1,1,'愤怒',1,'/mood/6.gif',6),(8,1,1,'同情',1,'/mood/7.gif',7),(9,2,1,'一星',1,NULL,0),(10,2,1,'二星',2,NULL,1),(11,2,1,'三星',3,NULL,2),(12,2,1,'四星',4,NULL,3),(13,2,1,'五星',5,NULL,4);
...
/*Data for the table `cms_sensitive_word` */
...
/*Data for the table `cms_site_clob` */
...
/*Data for the table `cms_special_category` */

LOCK TABLES `cms_special_category` WRITE;

insert  into `cms_special_category`(`f_speccate_id`,`f_site_id`,`f_name`,`f_seq`,`f_views`,`f_meta_keywords`,`f_meta_description`,`f_creation_date`) values (1,1,'国内',0,0,NULL,NULL,'2013-02-28 17:09:49'),(2,1,'国际',1,0,NULL,NULL,'2013-03-18 02:22:45'),(5,1,'娱乐',2147483647,0,NULL,NULL,'2014-11-27 20:47:03'),(6,1,'体育',2147483647,0,NULL,NULL,'2014-11-27 20:47:09');
...
/*Data for the table `cms_special_clob` */
...
/*Data for the table `cms_special_custom` */
...
/*Data for the table `cms_special_file` */
...
/*Data for the table `cms_special_image` */
...
/*Data for the table `cms_task` */

LOCK TABLES `cms_task` WRITE;

insert  into `cms_task`(`f_task_id`,`f_user_id`,`f_site_id`,`f_name`,`f_description`,`f_begin_time`,`f_end_time`,`f_total`,`f_type`,`f_status`) values (1,1,1,'Node: ALL',NULL,'2014-02-21 16:02:37','2014-02-21 16:02:45',52,3,1),(2,1,1,'Site: Jspxcms演示站',NULL,'2014-02-24 09:32:12','2014-02-24 09:32:12',0,1,1),(3,1,1,'Node: ALL',NULL,'2014-02-24 09:35:45','2014-02-24 09:35:52',52,3,1),(4,1,1,'Node: ALL',NULL,'2014-02-24 10:03:10','2014-02-24 10:03:21',52,3,1),(5,1,1,'Node: ALL',NULL,'2014-03-18 16:23:55','2014-03-18 16:24:05',54,3,1),(6,1,1,'Node: ALL',NULL,'2014-03-18 16:28:36','2014-03-18 16:28:44',50,3,1),(7,1,1,'Site: Jspxcms演示主站',NULL,'2014-09-10 11:10:49','2014-09-10 11:10:52',19,1,1),(8,1,1,'Node: ALL',NULL,'2014-12-13 23:29:39','2014-12-13 23:29:55',79,3,1),(9,1,1,'Node: ALL',NULL,'2015-04-10 14:42:53','2015-04-10 14:43:05',82,3,1),(10,1,1,'Node: 视频',NULL,'2015-04-10 14:43:35','2015-04-10 14:43:37',14,3,1),(11,1,1,'Node: ALL',NULL,'2015-04-10 14:43:59','2015-04-10 14:44:09',82,3,1),(12,1,1,'Node: ALL',NULL,'2015-04-10 14:47:25','2015-04-10 14:47:35',82,3,1),(13,1,1,'Node: ALL',NULL,'2015-04-10 15:02:19','2015-04-10 15:02:30',82,3,1),(14,1,1,'Node: ALL',NULL,'2015-12-24 10:43:08','2015-12-24 10:43:20',78,3,1),(15,1,1,'Site: Jspxcms演示主站',NULL,'2016-02-03 11:35:27','2016-02-03 11:35:28',0,1,1);
...
insert  into `cms_user`(`f_user_id`,`f_org_id`,`f_membergroup_id`,`f_global_id`,`f_username`,`f_password`,`f_salt`,`f_email`,`f_mobile`,`f_real_name`,`f_gender`,`f_birth_date`,`f_validation_type`,`f_validation_key`,`f_rank`,`f_type`,`f_status`,`f_qq_openid`,`f_weibo_uid`) values (0,1,1,1,'anonymous',NULL,NULL,'atarm@163.com',NULL,NULL,'M',NULL,NULL,NULL,1,1,1,NULL,NULL),(1,1,1,1,'admin','c7c422820e7fad41a91bee67f6db27f8dd33bd1a','41af478ee2e35a00','1936361047@qq.com',NULL,'管理员',NULL,NULL,'retrieve_password','9534b341033042ec83ada0136b431ee4',0,1,0,NULL,NULL);
...
/*Data for the table `cms_user_detail` */

LOCK TABLES `cms_user_detail` WRITE;

insert  into `cms_user_detail`(`f_user_id`,`f_validation_date`,`f_validation_value`,`f_login_error_date`,`f_login_error_count`,`f_prev_login_date`,`f_prev_login_ip`,`f_last_login_date`,`f_last_login_ip`,`f_creation_date`,`f_creation_ip`,`f_logins`,`f_is_with_avatar`,`f_bio`,`f_come_from`,`f_qq`,`f_msn`,`f_weixin`) values (0,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'2013-03-09 22:18:56','127.0.0.1',0,'0',NULL,NULL,'22807465',NULL,NULL),(1,'2015-04-12 10:27:43',NULL,NULL,0,'2016-02-03 15:57:28','127.0.0.1','2016-02-03 20:13:21','127.0.0.1','2013-02-21 20:59:27','127.0.0.1',577,'1',NULL,NULL,NULL,NULL,NULL);
...
/*Data for the table `cms_user_membergroup` */

LOCK TABLES `cms_user_membergroup` WRITE;

insert  into `cms_user_membergroup`(`f_usermgroup_id`,`f_user_id`,`f_membergroup_id`,`f_group_index`) values (2,1,1,0),(6,0,1,0);
...
/*Data for the table `cms_user_org` */

LOCK TABLES `cms_user_org` WRITE;

insert  into `cms_user_org`(`f_userorg_id`,`f_user_id`,`f_org_id`,`f_org_index`) values (2,1,1,0),(6,0,1,0);
...
/*Data for the table `cms_user_role` */
...
/*Data for the table `cms_visit_log` */

LOCK TABLES `cms_visit_log` WRITE;

insert  into `cms_visit_log`(`f_visitlog_id`,`f_site_id`,`f_url`,`f_referrer`,`f_ip`,`f_ip_date`,`f_cookie`,`f_cookie_date`,`f_date`,`f_time`) values (3584,1,'http://localhost:8080/','','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:30:00'),(3585,1,'http://localhost:8080/','http://localhost:8080/cmscp/index.do','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:30'),(3586,1,'http://localhost:8080/node/52.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:31'),(3587,1,'http://localhost:8080/node/48.jspx','http://localhost:8080/node/52.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:35'),(3588,1,'http://localhost:8080/node/36.jspx','http://localhost:8080/node/48.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:37'),(3589,1,'http://localhost:8080/','http://localhost:8080/node/36.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:38'),(3590,1,'http://localhost:8080/node/49.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:35:49'),(3591,1,'http://localhost:8080/node/69.jspx','http://localhost:8080/node/49.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:36:04'),(3592,1,'http://localhost:8080/info/146.jspx','http://localhost:8080/node/69.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:36:06'),(3593,1,'http://localhost:8080/resume.jspx?post=软件测试工程师','http://localhost:8080/info/146.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 11:36:08'),(3594,1,'http://localhost:8080/','http://localhost:8080/cmscp/index.do','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:09:48'),(3595,1,'http://localhost:8080/node/69.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:09:51'),(3596,1,'http://localhost:8080/info/144.jspx','http://localhost:8080/node/69.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:09:53'),(3597,1,'http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','http://localhost:8080/info/144.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:09:59'),(3598,1,'http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','http://localhost:8080/info/144.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:15:49'),(3599,1,'http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','http://localhost:8080/resume.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:16:45'),(3600,1,'http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','http://localhost:8080/resume.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:17:05'),(3601,1,'http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','http://localhost:8080/resume.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:51:19'),(3602,1,'http://localhost:8080/node/48.jspx','http://localhost:8080/resume.jspx?post=安卓 ios 软件工程师','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 14:55:52'),(3603,1,'http://localhost:8080/node/69.jspx','http://localhost:8080/node/48.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:03:26'),(3604,1,'http://localhost:8080/info/146.jspx','http://localhost:8080/node/69.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:03:28'),(3605,1,'http://localhost:8080/resume.jspx?post=软件测试工程师','http://localhost:8080/info/146.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:03:57'),(3606,1,'http://localhost:8080/','http://localhost:8080/my/avatar.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:04:48'),(3607,1,'http://localhost:8080/','','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:23:43'),(3608,1,'http://localhost:8080/info/126.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:24:02'),(3609,1,'http://localhost:8080/info/126_2.jspx','http://localhost:8080/info/126.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:24:06'),(3610,1,'http://localhost:8080/node/69.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:24:31'),(3611,1,'http://localhost:8080/info/146.jspx','http://localhost:8080/node/69.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 15:24:32'),(3612,1,'http://localhost:8080/','','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 20:12:40'),(3613,1,'http://localhost:8080/node/69.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 20:12:44'),(3614,1,'http://localhost:8080/info/146.jspx','http://localhost:8080/node/69.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 20:12:46'),(3615,1,'http://localhost:8080/resume.jspx?post=软件测试工程师','http://localhost:8080/info/146.jspx','127.0.0.1','127.0.0.12016-02-03','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-03','2016-02-03','2016-02-03 20:12:50'),(3616,1,'http://localhost:8080/','http://localhost:8080/cmscp/index.do','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:46:45'),(3617,1,'http://localhost:8080/','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:47:07'),(3618,1,'http://localhost:8080/node/36.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:47:09'),(3619,1,'http://localhost:8080/','http://localhost:8080/node/36.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:47:14'),(3620,1,'http://localhost:8080/node/36.jspx','http://localhost:8080/','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:48:31'),(3621,1,'http://localhost:8080/info/33.jspx','http://localhost:8080/node/36.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:49:26'),(3622,1,'http://localhost:8080/node/48.jspx','http://localhost:8080/node/36.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:49:43'),(3623,1,'http://localhost:8080/info/165.jspx','http://localhost:8080/node/48.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:50:15'),(3624,1,'http://localhost:8080/node/51.jspx','http://localhost:8080/node/48.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:50:27'),(3625,1,'http://localhost:8080/node/52.jspx','http://localhost:8080/node/51.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:51:22'),(3626,1,'http://localhost:8080/info/94.jspx','http://localhost:8080/node/52.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:56:30'),(3627,1,'http://localhost:8080/info/129.jspx','http://localhost:8080/node/52.jspx','127.0.0.1','127.0.0.12016-02-04','8cecfa3137054203a56c65db4cb8a038','8cecfa3137054203a56c65db4cb8a0382016-02-04','2016-02-04','2016-02-04 13:59:29');
...
/*Data for the table `cms_vote_mark` */
...
/*Data for the table `cms_vote_option` */

LOCK TABLES `cms_vote_option` WRITE;

insert  into `cms_vote_option`(`f_voteoption_id`,`f_vote_id`,`f_title`,`f_count`,`f_seq`) values (1,1,'朋友或同事介绍的',0,0),(2,1,'在技术网站中看到',2,1),(4,1,'通过搜索引擎',1,2),(6,1,'其它途径',3,3);
...
/*Data for the table `cms_workflow_group` */
...
/*Data for the table `cms_workflow_log` */
...
/*Data for the table `cms_workflow_process` */
...
/*Data for the table `cms_workflow_step` */
...
/*Data for the table `cms_workflowstep_role` */
...
CREATE TABLE `plug_resume` (
  ...
  `f_icon` varchar(500) DEFAULT NULL COMMENT '头像存放路径',
...
/*Data for the table `plug_resume` */

LOCK TABLES `plug_resume` WRITE;

insert  into `plug_resume`(`f_resume_id`,`f_site_id`,`f_name`,`f_post`,`f_creation_date`,`f_gender`,`f_birth_date`,`f_mobile`,`f_email`,`f_expected_salary`,`f_education_experience`,`f_work_experience`,`f_remark`,`f_icon`) values (3,1,'123','软件UI设计师','2014-12-08 17:38:37','M',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/uploads/1/file/public/1454501577737.jpg'),(4,1,'王大锤','安卓 ios 软件工程师','2016-02-03 14:16:41','M','2016-02-03 00:00:00','18209238826','316694467@qq.com',214,'阿斯顿高档','按时到岗','按时到岗','/uploads/1/file/public/1454501577737.jpg');
...
insert  into `qrtz_job_details`(`SCHED_NAME`,`JOB_NAME`,`JOB_GROUP`,`DESCRIPTION`,`JOB_CLASS_NAME`,`IS_DURABLE`,`IS_NONCONCURRENT`,`IS_UPDATE_DATA`,`REQUESTS_RECOVERY`,`JOB_DATA`) values ('schedulerFactory','1','DEFAULT',NULL,'com.jspxcms.core.quartz.InfoPublishJob','0','0','0','0','��\0sr\0org.quartz.JobDataMap���迩��\0\0xr\0&org.quartz.utils.StringKeyDirtyFlagMap�����](\0Z\0allowsTransientDataxr\0org.quartz.utils.DirtyFlagMap�.�(v\n�\0Z\0dirtyL\0mapt\0Ljava/util/Map;xpsr\0java.util.HashMap���`�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0siteIdt\01t\0userIdt\01t\0siteNamet\0Jspxcms演示主站x\0');
...
insert  into `qrtz_simple_triggers`(`SCHED_NAME`,`TRIGGER_NAME`,`TRIGGER_GROUP`,`REPEAT_COUNT`,`REPEAT_INTERVAL`,`TIMES_TRIGGERED`) values ('schedulerFactory','Trigger-1','DEFAULT',-1,600000,110);
...
insert  into `qrtz_triggers`(`SCHED_NAME`,`TRIGGER_NAME`,`TRIGGER_GROUP`,`JOB_NAME`,`JOB_GROUP`,`DESCRIPTION`,`NEXT_FIRE_TIME`,`PREV_FIRE_TIME`,`PRIORITY`,`TRIGGER_STATE`,`TRIGGER_TYPE`,`START_TIME`,`END_TIME`,`CALENDAR_NAME`,`MISFIRE_INSTR`,`JOB_DATA`) values ('schedulerFactory','Trigger-1','DEFAULT','1','DEFAULT',NULL,1454567536630,1454566936630,5,'WAITING','SIMPLE',1454501536630,0,NULL,0,'');
...
/*Data for the table `t_id_table` */

LOCK TABLES `t_id_table` WRITE;

insert  into `t_id_table`(`f_table`,`f_id_value`) values ('cms_ad',3),('cms_ad_slot',2),('cms_attachment',304),('cms_attachment_ref',238),('cms_attribute',10),('cms_collect',2),('cms_comment',32),('cms_friendlink',11),('cms_friendlinktype',4),('cms_guestbook',32),('cms_guestbooktype',9),('cms_info',181),('cms_info_attribute',495),('cms_info_membergroup',139),('cms_info_node',442),('cms_info_org',70),('cms_info_special',30),('cms_info_tag',82),('cms_member_group',2),('cms_model',28),('cms_model_field',567),('cms_node',98),('cms_node_membergroup',91),('cms_node_org',23),('cms_node_role',46),('cms_operation_log',1167),('cms_org',4),('cms_publish_point',3),('cms_question',3),('cms_question_item',8),('cms_question_item_rec',2),('cms_question_option',19),('cms_question_opt_rec',7),('cms_question_record',4),('cms_role',3),('cms_rolenode_info',1),('cms_rolenode_node',1),('cms_role_site',2),('cms_schedule_job',2),('cms_scoreboard',28),('cms_scoregroup',3),('cms_scoreitem',14),('cms_site',3),('cms_special',14),('cms_special_category',7),('cms_tag',85),('cms_task',16),('cms_user',18),('cms_user_membergroup',16),('cms_user_org',16),('cms_user_role',2),('cms_visit_log',3628),('cms_vote',2),('cms_vote_mark',96),('cms_vote_option',7),('cms_workflow',4),('cms_workflowprocess_user',1),('cms_workflowstep_role',2),('cms_workflow_group',3),('cms_workflow_step',5),('plug_resume',5);
